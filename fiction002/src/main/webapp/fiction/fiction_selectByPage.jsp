...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function getClasstList(pageNo){
				...
				$.ajax({
					url:"settings/book/selectList.do",
					data:{
						"xsid" : xsid,
						"xsmc":xsmc,
						"xszz":xszz,
					...
					success:function (data){
						...
						$.each(data.uList,function (i,n){//每一个n就是一个对象
							...
							html += "<td>"+n.bname+"</td>";
							html += "<td>"+n.author+"</td>";
							html += "<td><a href='${pageContext.request.contextPath}/settings/book/detailById.do?bid="+n.bid+"'>详细信息</a></td>";
							html += "<td><a href='fiction/chapter_selectByPage.jsp'>章节管理</a></td>";
							html += "<td><a href='${pageContext.request.contextPath}/settings/book/editById.do?bid="+n.bid+"'>编辑</a></td>";
							html += "<td><a href='${pageContext.request.contextPath}/settings/book/deleteById.do?bid="+n.bid+"'>删除</a></td>";
							html += "</tr>";
						})
						$("#tbody").html(html);
	...
	<body>
		<div id="top">当前位置：小说管理 -- 查看小说类别</div>
		<div id="contexttop">
			...
			<tr>
				<form>
					<td colspan="7" align="center">
						...
						<input type="text"  name="xsmc" placeholder="小说名称" />
						<input type="text"  name="xszz" placeholder="小说作者" />
